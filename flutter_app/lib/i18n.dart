...
class I18n {
  ...
  static const Map<String, Map<String, String>> _m = {
    'uz': {
      ...
      'add_workplace': "Ish joyi qo'shish", 'job_name': 'Ish joyi nomi', 'hourly': 'Soatbay',
      'daily': 'Kunbay', 'rate': 'Stavka (₩)', 'tax': 'Soliq (%)', 'per_hour': 'soat', 'per_day': 'kun',
    ...
    'en': {
      ...
      'add_workplace': 'Add workplace', 'job_name': 'Workplace name', 'hourly': 'Hourly',
      'daily': 'Daily', 'rate': 'Rate (₩)', 'tax': 'Tax (%)', 'per_hour': 'hr', 'per_day': 'day',
    ...
    'ko': {
      ...
      'add_workplace': '근무지 추가', 'job_name': '근무지 이름', 'hourly': '시급',
      'daily': '일급', 'rate': '요율 (₩)', 'tax': '세금 (%)', 'per_hour': '시간', 'per_day': '일',
