...
class I18n {
  ...
  static const Map<String, Map<String, String>> _m = {
    'uz': {
      ...
      'fin_expense': 'Chiqim', 'fin_debt': 'Qarz', 'fin_income': 'Daromad', 'fin_add': "Yozuv qo'shish",
      'fin_title': 'Nomi', 'fin_amount': 'Summa (₩)', 'fin_pay': "To'lash", 'fin_paid': "To'landi",
      'fin_none': "Hali yozuv yo'q", 'fin_due': 'Har oy kuni (1-31, ixtiyoriy)', 'stays': 'Qoladi',
      'earned_this_month': 'Bu oy topilgan', 'monthly_expenses': 'Doimiy chiqim', 'leftover': 'Qoladigan summa',
      ...
      'full_name': "To'liq ism (F.I.O.)", 'phone': 'Telefon raqam', 'continue': 'Davom etish',
      'password': 'Parol', 'password_if_set': "Parol (agar qo'ygan bo'lsangiz)", 'password_optional': "Parol (ixtiyoriy)",
      'cred_hint': "Parol qo'ygan bo'lsangiz parolni, aks holda tug'ilgan kunni kiriting.",
      'welcome_back': 'Xush kelibsiz', 'create_account': 'Akkaunt ochish',
    ...
    'en': {
      ...
      'fin_expense': 'Expense', 'fin_debt': 'Debt', 'fin_income': 'Income', 'fin_add': 'Add record',
      'fin_title': 'Name', 'fin_amount': 'Amount (₩)', 'fin_pay': 'Pay', 'fin_paid': 'Paid off',
      'fin_none': 'No records yet', 'fin_due': 'Monthly day (1-31, optional)', 'stays': 'Left',
      'earned_this_month': 'Earned this month', 'monthly_expenses': 'Expenses', 'leftover': 'Remaining',
      ...
      'full_name': 'Full name', 'phone': 'Phone number', 'continue': 'Continue',
      'password': 'Password', 'password_if_set': 'Password (if you set one)', 'password_optional': 'Password (optional)',
      'cred_hint': 'Enter your password if you set one, otherwise your birthdate.',
    ...
    'ko': {
      ...
      'fin_expense': '지출', 'fin_debt': '부채', 'fin_income': '수입', 'fin_add': '항목 추가',
      'fin_title': '이름', 'fin_amount': '금액 (₩)', 'fin_pay': '결제', 'fin_paid': '완납',
      'fin_none': '항목이 없습니다', 'fin_due': '매월 일 (1-31, 선택)', 'stays': '남음',
      'earned_this_month': '이번 달 수입', 'monthly_expenses': '지출', 'leftover': '남는 금액',
      ...
      'full_name': '전체 이름', 'phone': '전화번호', 'continue': '계속',
      'password': '비밀번호', 'password_if_set': '비밀번호 (설정한 경우)', 'password_optional': '비밀번호 (선택)',
      'cred_hint': '비밀번호를 설정했다면 비밀번호를, 아니면 생년월일을 입력하세요.',
      'welcome_back': '다시 오신 걸 환영합니다', 'create_account': '계정 만들기',
